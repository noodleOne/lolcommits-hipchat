...
[Fork](https://guides.github.com/activities/forking) then clone the repository:
    ...
    git clone git@github.com:your-username/lolcommits-hipchat.git
...
Request](https://github.com/lolcommits/lolcommits-hipchat/compare):
...
* If you are fixing an
  [issue](https://github.com/lolcommits/lolcommits-hipchat/issues), link to
